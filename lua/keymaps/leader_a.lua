...
--     expand = true,
--   }, function(value)
--     f.translate_text({ content = value, language = "English", target_language = "Chinese" })
--   end)
-- end
...
--     expand = true,
--   }, function(value)
--     f.translate_text({ content = value, language = "Chinese", target_language = "English" })
--   end)
-- end
...
return {
  ...
  { "<C-Right>",  mode = { "i" }, function() f.accept_word()            end,     desc = "Fittencode accept word"            },
  { "<C-Down>",   mode = { "i" }, function() f.accept_line()            end,     desc = "Fittencode accept libe"            },
  { "<C-Left>",   mode = { "i" }, function() f.revoke_word()            end,     desc = "Fittencode revoke word"            },
  { "<C-Up>",     mode = { "i" }, function() f.revoke_line()            end,     desc = "Fittencode revoke libe"            },
