...
return {
  ...
  -- { "<leader>bp", mode = { "n" }, "<Cmd>BufferPrevious<CR>",            desc = "BufferPrevious",      noremap = true, silend = true },
  -- { "<leader>bn", mode = { "n" }, "<Cmd>BufferNext<CR>",                desc = "BufferNext",          noremap = true, silend = true },
  -- { "<leader>bP", mode = { "n" }, "<Cmd>BufferMovePrevious<CR>",        desc = "BufferMovePrevious",  noremap = true, silend = true },
  -- { "<leader>bN", mode = { "n" }, "<Cmd>BufferMoveNext<CR>",            desc = "BufferMoveNext",      noremap = true, silend = true },
  -- { "<leader>b!", mode = { "n" }, "<Cmd>BufferPin<CR>",                 desc = "BufferPin",           noremap = true, silend = true },
  -- { "<leader>b@", mode = { "n" }, "<Cmd>BufferPick<CR>",                desc = "BufferPick",          noremap = true, silend = true },
  -- { "<leader>b#", mode = { "n" }, "<Cmd>BufferPickDelete<CR>",          desc = "BufferPickDelete",    noremap = true, silend = true },
  }
-- stylua: ignore end
